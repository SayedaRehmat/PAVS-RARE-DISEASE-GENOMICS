...
│
└── docs/
    └── PAVS_Research_Proposal_Sayeda_Rehmat.pdf
```
...
For academic collaboration, research discussion, or computational genomics inquiries, please connect through GitHub.
