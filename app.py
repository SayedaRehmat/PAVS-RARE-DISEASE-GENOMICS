...
# ═════════════════════════════════════════════════════════════════════════════
    ...
    st.markdown(f'<div class="urgent-box"> CLINICAL URGENCY: <b>{len(unsolved_t)} unsolved patients</b> '
...
# ═════════════════════════════════════════════════════════════════════════════
elif page == " Variant Pathogenicity":
    st.title(" Variant Pathogenicity Classification")
